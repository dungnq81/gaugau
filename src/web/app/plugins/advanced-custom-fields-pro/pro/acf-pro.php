...
if (! class_exists('acf_pro')) :
    ...
    class acf_pro
    {
        ...
        public function register_assets()
        {
            ...
            // Register styles.
            wp_register_style('acf-pro-input', acf_get_url('assets/build/css/pro/acf-pro-input' . $min . '.css'), ['acf-input'], $version);
            wp_register_style('acf-pro-field-group', acf_get_url('assets/build/css/pro/acf-pro-field-group' . $min . '.css'), ['acf-input'], $version);
