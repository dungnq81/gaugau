...
if (! class_exists('ACF_Assets')) :
    ...
    class ACF_Assets
    {
        ...
        public function register_scripts()
        {
            ...
            // Register styles.
            wp_register_style('acf-global', acf_get_url('assets/build/css/acf-global' . $suffix . '.css'), ['dashicons'], $version);
            wp_register_style('acf-input', acf_get_url('assets/build/css/acf-input' . $suffix . '.css'), ['acf-global'], $version);
            wp_register_style('acf-field-group', acf_get_url('assets/build/css/acf-field-group' . $suffix . '.css'), ['acf-input'], $version);
